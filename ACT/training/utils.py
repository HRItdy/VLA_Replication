...
#     # Determine the maximum sequence length in all episodes
#     max_qpos_length = 0
#     max_action_length = 0
...
#             action = root['/action'][()]
#             max_qpos_length = max(max_qpos_length, qpos.shape[0])
#             max_action_length = max(max_action_length, action.shape[0])
...
#             # Pad qpos to max_qpos_length
#             padded_qpos = F.pad(torch.from_numpy(qpos), (0, 0, 0, max_qpos_length - qpos.shape[0]))
#             padded_action = F.pad(torch.from_numpy(action), (0, 0, 0, max_action_length - action.shape[0]))
#             # Append the padded qpos and action data
#             all_qpos_data.append(padded_qpos)
#             all_action_data.append(padded_action)
